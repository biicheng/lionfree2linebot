...
Route::get('/List', 'HomeController@lineBotHome');
...
Route::get('/mesaageView/{utext?}', 'DataUpdateController@index');
// Route::get('/update/{utext?}', 'DataUpdateController@index');
// Route::post('/update', 'DataUpdateController@updateD')->name('update');
Route::post('/editMessage', 'DataUpdateController@updateD')->name('editMessage');
