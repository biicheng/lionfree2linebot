      ...
      .done(function( msg ) {
        ...
        else
        {
            ...
            {
                var Data = new Array();
                var Data = msg.split('"}, { "',10);
                var DataG = new Array();
                var DataG = Data[0].split('","',10);
                var DataB = new Array();
                var DataB = Data[1].split('","',10);

                //往小港or西子灣
                if(Mid[0]=='124' || Mid[0]=='214')
                {
                    //取第一站與最後一站往反方向名稱
                    var ToN1 = new Array();
                    var ToN1 = DataB[0].split('descr":"',10);
                    /*var ToN = new Array();
                    var ToN1 = ToN[1].split('","arrival"',10);*/

                    //取第一站與最後一站往反方向下一班時間
                    var thistime1 = new Array();
                    var thistime1 = DataB[1].split('arrival":"',10);
                    //var thistime1 = new Array();
                    //var thistime1 = thistime[1].split('","next_arriva',10);
                    if(thistime1[1] > 0){ exttime2 = thistime1[1].concat('分鐘後'); }
                    else if(thistime1[1] == 0){ exttime2 = '進站中.'; }
                    else if(thistime1[1] == '-'){ exttime2 = thistime1[1].concat('分鐘後'); }
                    else{ exttime2 = "未發車."; }

                    //取第一站與最後一站往反方向下下一班時間
                    var nexttimes1 = new Array();
                    var nexttimes1 = DataB[2].split('next_arrival":"',10);
                    //var nexttime1 = new Array();
                    //var nexttime1 = nexttime[1].split('"},',10);
                    //var nexttimes1 = new Array();
                    //var nexttimes1 = nexttime1[0].split('"',10);
                    if(nexttimes1[0] > 0){ nexttime2 = '分鐘後</span><br>'; }
                    else{ nexttime2 = nexttimes1[0].concat("未發車</span><br>"); }
                    $("button1").remove();
                }

                //往南岡山or大寮
                if(Mid[0]=='101' || Mid[0]=='201')
                {
                    //取第一站與最後一站往反方向名稱
                    var ToN1 = new Array();
                    var ToN1 = DataG[0].split('descr":"',10);
                    /*var ToN = new Array();
                    var ToN1 = ToN[1].split('","arrival"',10);*/

                    //取第一站與最後一站往反方向下一班時間
                    var thistime1 = new Array();
                    var thistime1 = DataG[1].split('arrival":"',10);
                    //var thistime1 = new Array();
                    //var thistime1 = thistime[1].split('","next_arriva',10);
                    if(thistime1[1] > 0){ exttime2 = thistime1[1].concat('分鐘後'); }
                    else if(thistime1[1] == 0){ exttime2 = '進站中.'; }
                    ...
                    //取第一站與最後一站往反方向下下一班時間
                    var nexttimes1 = new Array();
                    var nexttimes1 = DataG[2].split('next_arrival":"',10);
                    //var nexttime1 = new Array();
                    //var nexttime1 = nexttime[1].split('"},',10);
                    //var nexttimes1 = new Array();
                    //var nexttimes1 = nexttime1[0].split('"',10);
                ...
                //字串組合
                var ToNS = "</p>".concat("<span>往",ToN1[1],":&emsp;<br>下一班：",exttime2,"&nbsp;/&nbsp;下下班：",nexttime2);//往:",ToN1[0],"<br>
            }
            else
            {
                var Data = new Array();
                ...
                //取往南岡山or大寮名稱
                var ToN1 = new Array();
                var ToN1 = DataG[0].split('{ "MRT":[{ "descr":"',10);
                //var ToN1 = new Array();
                //var ToN1 = ToN[1].split('","arrival"',10);
                ...
                //var thistime1 = new Array();
                //var thistime1 = thistime[1].split('","next_arriva',10);
                if(thistime1[1] == '--'){ exttime2 = '未發車'; }
                else if(thistime1[1] == 0){ exttime2 = '進站中'; }
                else{ exttime2 = thistime1[1].concat("分鐘後"); }

                //取往南岡山or大寮下下一班時間
                var nexttime = new Array();
                var nexttime = DataG[2].split('next_arrival":"',10);
                var nexttime1 = new Array();
                var nexttime1 = nexttime[1].split('"',10);
                ...
                //往南岡山or大寮字串組合
                var ToE = "</p>".concat("<span>往",ToN1[1],":&emsp;<br>下一班：",exttime2,"&nbsp;/&nbsp;下下班：",nexttime2);//往:",ToN1[0],"<br>


                //取往小港or西子灣名稱
                var ToWe1 = new Array();
                var ToWe1 = DataB[0].split('descr":"',10);
                //var ToWe1 = new Array();
                ...
                var Wthistime1 = DataB[1].split('arrival":"',10);
                //var Wthistimes = new Array();
                //var Wthistimes = Wthistime1[0].split('"',10);
                if(Wthistime1[1] == '--'){ Wexttime2 = '未發車'; }
                else if(Wthistime1[1] == 0){ Wexttime2 = '進站中'; }
                else{ Wexttime2 = Wthistime1[1].concat("分鐘後"); }
               ...
               // var Wnexttime = msg.split('"next_arrival":"',10);
                ...
                var Wnexttimes = DataB[2].split('"',10);
                //var Wnexttimess = new Array();
                //var Wnexttimess = Wnexttimes[1].split('"',10);
                if(Wnexttimes[2] == '--'){ Wnexttime2 = '未發車</span><br>'; }
                else{ Wnexttime2 = Wnexttimes[2].concat("分鐘後</span><br>"); }
