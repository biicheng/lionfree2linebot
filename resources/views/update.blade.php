                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update') }}">
                        ...
                        <div class="form-group row" style="margin-top:3%;">
                            ...
                            <div class="col-md-6">{{--autofocus--}}
                                @if($messageD[0]['bImg']!='')
                                    <img src="{{$messageD[0]['bImg']}}" style="max-width:100%;padding-top:5%;" />
                                    換圖：<input id="bImg" type="file" class="form-control" name="bImg">
                                @else
                                    <input id="bImg" type="file" class="form-control" name="bImg">
                                @endif
                            </div>
                        </div>
                        <div class="form-group row" style="margin-top:3%;">
                            ...
                            <div class="col-md-6">{{--autofocus--}}
                                @if($messageD[0]['sImg']!='')
                                    <img src="{{$messageD[0]['sImg']}}" style="max-width:100%;padding-top:5%;" />
                                    換圖：<input id="sImg" type="file" class="form-control" name="sImg">
                                @else
                                    <input id="sImg" type="file" class="form-control" name="sImg">
                                @endif
                            </div>
                        </div>
